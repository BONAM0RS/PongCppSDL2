...
void RectComponent::setPosX(int xPos)    
{ 
	m_trackingRect.x = xPos; 
}


void RectComponent::setPosY(int yPos)    
{ 
	m_trackingRect.y = yPos; 
}


void RectComponent::setWidth(int wSize)  
{ 
	m_trackingRect.w = wSize; 
}


void RectComponent::setHeight(int hSize) 
{ 
	m_trackingRect.h = hSize;
}
...
void RectComponent::setDirX(int xDir)   
{ 
	m_trackingParams.dirX = xDir;  
}


void RectComponent::setDirY(int yDir)   
{ 
	m_trackingParams.dirY = yDir; 
}


void RectComponent::setSpeed(int speed) 
{ 
	m_trackingParams.spd = speed;
}
...
SDL_Rect RectComponent::getRect() const
{ 
	return m_trackingRect; 
}


int RectComponent::getPosX() const   { return m_trackingRect.x; }
int RectComponent::getPosY() const   { return m_trackingRect.y; }
int RectComponent::getWidth() const  { return m_trackingRect.w; }
int RectComponent::getHeight() const { return m_trackingRect.h; }


int RectComponent::getDirX() const  { return m_trackingParams.dirX; }
int RectComponent::getDirY() const  { return m_trackingParams.dirY; }
int RectComponent::getSpeed() const { return m_trackingParams.spd;  }
