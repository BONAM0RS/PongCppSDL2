...
private:
	...
	const char* backgroundImagePath = "./assets/images/background.png";

	const char* paddleImagePath = "./assets/images/paddle.png";
	const char* ballImagePath = "./assets/images/ball.png";

	const char* peepoFontPath = "./assets/fonts/Peepo.ttf";

	const char* backgroundMusicPath = "./assets/music/background.mp3";

	const char* collideSoundPath = "./assets/sounds/collide.wav";
	const char* scoreSoundPath = "./assets/sounds/score.wav";
